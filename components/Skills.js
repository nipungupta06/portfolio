...
const Skills = () => {
    return (
        <div className='bg-[#08131c] pb-10'>
            <h2 className="text-3xl lg:text-5xl  text-center py-10">My Skills</h2>
            <section className="text-gray-400 body-font">
                <div className="container px-5 py-4 mx-auto">

                    <div className="flex flex-wrap">
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex items-center border-gray-800 border p-2 lg:p-4 rounded-lg">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">C++</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">Python</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">JavaScript</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">MySQL</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">MongoDB</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">NextJs</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">ReactJs</h2>
                        ...
                        <div className="p-2 lg:w-1/4 sm:w-1/2 w-full">
                            <div className="h-full flex  items-center border-gray-800 border p-2 lg:p-4 rounded-lg ">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-white title-font font-medium text-lg lg:text-2xl">NodeJs</h2>
